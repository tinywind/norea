...
export interface StringMap {
  ...
  'library.localImport.open': 'string';
  'library.localImport.title': 'string';
  'library.localImport.analyzing': 'string';
  'library.localImport.empty': 'string';
  'library.localImport.summary': 'string';
  'library.localImport.importReady': 'string';
  'library.localImport.formatUnknown': 'string';
  'library.localImport.error': 'string';
  'library.localImport.duplicateLibrary': 'string';
  'library.localImport.duplicateSelected': 'string';
  'library.localImport.importedDetail': 'string';
  'library.localImport.status.ready': 'string';
  'library.localImport.status.duplicate': 'string';
  'library.localImport.status.unsupported': 'string';
  'library.localImport.status.error': 'string';
  'library.localImport.status.importing': 'string';
  'library.localImport.status.imported': 'string';
